...
import "./Post.scss"
export const Post = ({postContent, postImage}) => {
  return (
    <>
    {
      !postContent && !postImage ? <h2 className="no_post">No Post Found</h2> :
        <div className="user_new_post_list">
          <div className="single_post_card">
            <div className="post_author_image">
              <img src="https://pbs.twimg.com/profile_images/1645880810958929921/8mi_I17M_normal.jpg" alt="" />
            </div>
            <div className="post_image_and_text_and_auth">
              <div className="post_auth_detels">
                <div className="post_others">
                  <b><a href="">Mamun Mirdha</a></b>
                  <a href="">@mamun_mirdha</a> . 
                  <a href="">12m</a>
                </div>
                <div className="more_edit">
                  <span><HiOutlineDotsHorizontal /></span>
                </div>
              </div>
              <div className="post_contents_images_text">
                {
              ...
              <div className="post_future_like_comments">
                <ul>
                  <li><a href="">
                    <span>
